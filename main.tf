...
Updated: Thu Apr  7 21:24:30 +08 2022 */
...
module "rest-api-lambda-endpoint" {
  ...
  lambda_env_variables = {ENCODiNG: "latin-1", CORS: "*", IP_TABLE: "${module.appstream.iptable}", EMAIL_TABLE: "${module.appstream.email_table}", STACK: "${module.appstream.stack_name}", FLEET: "${module.appstream.fleet_name}", APP: "${module.appstream.image_name}", AUTH_TYPE: "${module.appstream.auth_type}", GAP_TIME: 1, SIM_VALIDITY: 3600}
